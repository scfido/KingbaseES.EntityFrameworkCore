...
public static class KdbndpAnnotationNames
{
    public const string Prefix = "Kdbndp:";
    ...
    /// <summary>
    /// Identifies the type of the KingbaseES type of this column (e.g. array, range, base).
    /// </summary>
