...
public class KdbndpMethodCallTranslatorProvider : RelationalMethodCallTranslatorProvider
{
        ...
        : base(dependencies)
    {
        ...
        {
            new KdbndpArrayTranslator(sqlExpressionFactory, jsonTranslator, npgsqlSingletonOptions.UseRedshift),
            ...
            new KdbndpNewGuidTranslator(sqlExpressionFactory, npgsqlSingletonOptions),
            new KdbndpObjectToStringTranslator(typeMappingSource, sqlExpressionFactory),
            new KdbndpRandomTranslator(sqlExpressionFactory),
            new KdbndpRangeTranslator(typeMappingSource, sqlExpressionFactory, model, npgsqlSingletonOptions),
