...
/// <summary>
/// Translates method and property calls on arrays/lists into their corresponding KingbaseES operations.
/// </summary>
/// <remarks>
/// https://www.postgresql.org/docs/current/static/functions-array.html
/// </remarks>
public class KdbndpArrayTranslator : IMethodCallTranslator, IMemberTranslator
{
    #region Methods
    ...
    public KdbndpArrayTranslator(
        KdbndpSqlExpressionFactory sqlExpressionFactory,
        KdbndpJsonPocoTranslator jsonPocoTranslator,
        bool useRedshift)
    {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        {
            // Translate list[i]. Note that array[i] is translated by KdbndpSqlTranslatingExpressionVisitor.VisitBinary (ArrayIndex)
        ...
        static bool IsMappedToNonArray(SqlExpression arrayOrList)
            => arrayOrList.TypeMapping is RelationalTypeMapping and not (KdbndpArrayTypeMapping or KdbndpJsonTypeMapping);
        ...
        SqlExpression? TranslateCommon(SqlExpression arrayOrList, IReadOnlyList<SqlExpression> arguments)
        {
            ...
            if ((method.IsClosedFormOf(Enumerable_Contains)
                ...
                arrayOrList.TypeMapping is KdbndpArrayTypeMapping or null
                && !_useRedshift)
            {
            ...
            // to LIKE ANY (...). See KdbndpSqlTranslatingExpressionVisitor.VisitArrayMethodCall.
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        if (instance?.Type.IsGenericList() == true &&
            ...
            (instance.TypeMapping is KdbndpArrayTypeMapping || instance.TypeMapping is null))
        {
