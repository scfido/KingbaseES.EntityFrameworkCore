...
namespace Kdbndp.EntityFrameworkCore.KingbaseES.Internal
{
    ...
    public static class KdbndpResources
    {
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogEnumColumnSkipped;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogEnumColumnSkipped,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        KdbndpEventId.EnumColumnSkippedWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.EnumColumnSkippedWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogExpressionIndexSkipped;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogExpressionIndexSkipped,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        KdbndpEventId.ExpressionIndexSkippedWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.ExpressionIndexSkippedWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundCollation;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundCollation,
                    logger,
                    static logger => new EventDefinition<string, string, string, string, string?, bool>(
                        logger.Options,
                        KdbndpEventId.CollationFound,
                        LogLevel.Debug,
                        "KdbndpEventId.CollationFound",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundColumn;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundColumn,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        KdbndpEventId.ColumnFound,
                        LogLevel.Debug,
                        "KdbndpEventId.ColumnFound",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundForeignKey;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundForeignKey,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        KdbndpEventId.ForeignKeyFound,
                        LogLevel.Debug,
                        "KdbndpEventId.ForeignKeyFound",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundIndex;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundIndex,
                    logger,
                    static logger => new EventDefinition<string, string, bool>(
                        logger.Options,
                        KdbndpEventId.IndexFound,
                        LogLevel.Debug,
                        "KdbndpEventId.IndexFound",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundPrimaryKey,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        KdbndpEventId.PrimaryKeyFound,
                        LogLevel.Debug,
                        "KdbndpEventId.PrimaryKeyFound",
                        level => LoggerMessage.Define<string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundSequence;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundSequence,
                    logger,
                    static logger => new FallbackEventDefinition(
                        logger.Options,
                        KdbndpEventId.SequenceFound,
                        LogLevel.Debug,
                        "KdbndpEventId.SequenceFound",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundTable;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundTable,
                    logger,
                    static logger => new EventDefinition<string>(
                        logger.Options,
                        KdbndpEventId.TableFound,
                        LogLevel.Debug,
                        "KdbndpEventId.TableFound",
                        level => LoggerMessage.Define<string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogFoundUniqueConstraint,
                    logger,
                    static logger => new EventDefinition<string?, string>(
                        logger.Options,
                        KdbndpEventId.UniqueConstraintFound,
                        LogLevel.Debug,
                        "KdbndpEventId.UniqueConstraintFound",
                        level => LoggerMessage.Define<string?, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogMissingSchema;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogMissingSchema,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        KdbndpEventId.MissingSchemaWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.MissingSchemaWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogMissingTable;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogMissingTable,
                    logger,
                    static logger => new EventDefinition<string?>(
                        logger.Options,
                        KdbndpEventId.MissingTableWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.MissingTableWarning",
                        level => LoggerMessage.Define<string?>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogPrincipalColumnNotFound,
                    logger,
                    static logger => new EventDefinition<string, string, string, string>(
                        logger.Options,
                        KdbndpEventId.ForeignKeyPrincipalColumnMissingWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.ForeignKeyPrincipalColumnMissingWarning",
                        level => LoggerMessage.Define<string, string, string, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogPrincipalTableNotInSelectionSet,
                    logger,
                    static logger => new EventDefinition<string?, string?, string?>(
                        logger.Options,
                        KdbndpEventId.ForeignKeyReferencesMissingPrincipalTableWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.ForeignKeyReferencesMissingPrincipalTableWarning",
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogUnsupportedColumnConstraintSkipped;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogUnsupportedColumnConstraintSkipped,
                    logger,
                    static logger => new EventDefinition<string?, string>(
                        logger.Options,
                        KdbndpEventId.UnsupportedColumnConstraintSkippedWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.UnsupportedColumnConstraintSkippedWarning",
                        level => LoggerMessage.Define<string?, string>(
                            level,
        ...
        {
            var definition = ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogUnsupportedColumnIndexSkipped;
            if (definition is null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KdbndpLoggingDefinitions)logger.Definitions).LogUnsupportedColumnIndexSkipped,
                    logger,
                    static logger => new EventDefinition<string, string>(
                        logger.Options,
                        KdbndpEventId.UnsupportedColumnIndexSkippedWarning,
                        LogLevel.Warning,
                        "KdbndpEventId.UnsupportedColumnIndexSkippedWarning",
                        level => LoggerMessage.Define<string, string>(
                            level,
