...
/// <summary>
/// Provides methods for supporting translation to KingbaseES JSON operators and functions.
/// </summary>
public static class KdbndpJsonDbFunctionsExtensions
{
    /// <summary>
    ...
    /// </param>
    /// <remarks>
    /// This operation is only supported with KingbaseES <c>jsonb</c>, not <c>json</c>.
    ///
