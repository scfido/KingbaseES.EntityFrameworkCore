...
public static class KdbndpPropertyBuilderExtensions
{
        ...
        long? numbersToCache = null)
    {
        ...
        return propertyBuilder.CanSetAnnotation(KdbndpAnnotationNames.IdentityOptions, value);
    }
    ...
    /// <param name="includedPropertyNames">An array of property names to be included in the tsvector.</param>
    /// <returns>A builder to further configure the property.</returns>
    public static PropertyBuilder<KdbndpTsVector> IsGeneratedTsVectorColumn(
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return propertyBuilder.CanSetAnnotation(KdbndpAnnotationNames.CompressionMethod, compressionMethod, fromDataAnnotation);
    }
