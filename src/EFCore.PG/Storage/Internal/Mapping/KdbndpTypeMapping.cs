...
public abstract class KdbndpTypeMapping : RelationalTypeMapping, IKdbndpTypeMapping
{
    ...
    public KdbndpTypeMapping(string storeType, Type clrType, KdbndpDbType npgsqlDbType)
    ...
    protected KdbndpTypeMapping(RelationalTypeMappingParameters parameters, KdbndpDbType npgsqlDbType)
        : base(parameters)
        => KdbndpDbType = npgsqlDbType;
