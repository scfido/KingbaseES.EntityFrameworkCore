...
public class KdbndpTypeMappingSource : RelationalTypeMappingSource
{
    ...
    private readonly KdbndpTsQueryTypeMapping   _tsquery               = new();
    ...
    //private readonly KdbndpLTreeTypeMapping           _ltree           = new();
...
// ReSharper restore CoVariantArrayConversion
        ...
        _userRangeDefinitions = npgsqlSingletonOptions?.UserRangeDefinitions ?? new UserRangeDefinition[0];
    }
    ...
    protected virtual void SetupEnumMappings(ISqlGenerationHelper sqlGenerationHelper)
    {
        ...
        //var adoUserTypeMappings = (IDictionary<string, IUserTypeMapping>)_adoUserTypeMappingsGetMethodInfo.Invoke(KdbndpConnection.GlobalTypeMapper, Array.Empty<object>())!;
        ...
        //    var mapping = new KdbndpEnumTypeMapping(
