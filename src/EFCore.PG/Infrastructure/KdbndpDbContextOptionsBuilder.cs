    ...
    : RelationalDbContextOptionsBuilder<KdbndpDbContextOptionsBuilder, KdbndpOptionsExtension>
{
    ...
    public virtual KdbndpDbContextOptionsBuilder ProvideClientCertificatesCallback(
    ...
    /// </summary>
    /// <param name="callback">The callback to use.</param>
    public virtual KdbndpDbContextOptionsBuilder RemoteCertificateValidationCallback(
    ...
    ///// </summary>
    ///// <param name="callback">The callback to use.</param>
    //public virtual KdbndpDbContextOptionsBuilder ProvidePasswordCallback(
