...
public static class KdbndpDbContextOptionsBuilderExtensions
{
    ...
    /// <param name="npgsqlOptionsAction">An optional action to allow additional Kdbndp-specific configuration.</param>
    /// <returns>The options builder so that further configuration can be chained.</returns>
    public static DbContextOptionsBuilder UseKdbndp(
        this DbContextOptionsBuilder optionsBuilder,
        Action<KdbndpDbContextOptionsBuilder>? npgsqlOptionsAction = null)
    {
        ...
        npgsqlOptionsAction?.Invoke(new KdbndpDbContextOptionsBuilder(optionsBuilder));
    ...
    /// <param name="optionsBuilder">A builder for setting options on the context.</param>
    /// <param name="connectionString">The connection string of the database to connect to.</param>
    /// <param name="npgsqlOptionsAction">An optional action to allow additional Kdbndp-configuration.</param>
    /// <returns>
    /// The options builder so that further configuration can be chained.
    /// </returns>
    public static DbContextOptionsBuilder<TContext> UseKdbndp<TContext>(
