...
/// <summary>
/// Kdbndp specific extension methods for <see cref="IndexBuilder" />.
/// </summary>
public static class KdbndpIndexBuilderExtensions
{
    #region Method
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.IndexMethod, method, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.IndexOperators, operators, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.TsVectorConfig, config, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.IndexSortOrder, values, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.IndexNullSortOrder, values, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(KdbndpAnnotationNames.CreatedConcurrently, createdConcurrently, fromDataAnnotation);
    }
